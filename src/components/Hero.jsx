  ...
  return (
    <section className=" font-BeVietnamPro text-[16px] flex flex-col gap-8 mt-10 lg:flex-row-reverse lg:mx-[5rem] lg:py-6">
      ...
      <div>
        ...
        <div className=" w-36 bg-BrightRed h-12 mx-auto px-[1.6rem] py-[0.77rem] rounded-[23px] text-VeryPaleRed  my-4 shadow-lg lg:cursor-pointer whitespace-nowrap shadow-BrightRed mt-8 lg:ml-11 lg:mt-12">
          Get Started
        </div>
      </div>
    </section>
